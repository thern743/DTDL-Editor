...
export class SchemaService implements IFormFactory, IModelFactory {
  ...
  public registerModels(): void {
    ...
    this.schemaFactory.registerModel("Utility", "commandPayload", () => new CommandPayload("dtmi:com:Example:MyCommandPayload;1"));
  ...
  public registerForms(): void {
    ...
    this.schemaFactory.registerFormControl("Utility", "commandPayload", () => new CommandPayloadFormControl(this.createModel("Utility", "commandPayload") as CommandPayload, this._formBuilder, this._validationService));
